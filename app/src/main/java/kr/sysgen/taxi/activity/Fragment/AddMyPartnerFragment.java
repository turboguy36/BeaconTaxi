 ...
 * {@link AddMyPartnerFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AddMyPartnerFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AddMyPartnerFragment extends Fragment implements View.OnClickListener{
    public static final String TAG = AddMyPartnerFragment.class.getSimpleName();
    ...
    public static AddMyPartnerFragment newInstance(String param1, String param2) {
        AddMyPartnerFragment fragment = new AddMyPartnerFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ((BaseActivity) getActivity()).getToolbar().setTitle("보호자 지정");
                ...
                dialog.setTitle(R.string.text_success).setMessage(R.string.message_set_parent_complete)
                        .setPositiveButton(getString(R.string.text_confirm), new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ShowMyParentFragment fragment = ShowMyParentFragment.newInstance(1);
                                ((BaseActivity)getActivity()).addFragment(fragment, ShowMyParentFragment.TAG);
                            }
                        });
                dialog.show();
            } else {
